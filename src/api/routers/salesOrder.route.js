...
router.post("/createSalesOrder", validateRole(["Admin"]), salesOrderController.createSalesOrder);
router.get("/getSalesOrders", validateRole(["Admin"]), salesOrderController.getSalesOrders);
